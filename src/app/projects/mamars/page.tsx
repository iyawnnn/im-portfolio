    ...
    <div className="flex w-full max-w-6xl mx-auto flex-col gap-12 p-4 pt-8 md:p-8 md:pt-20 lg:p-12 lg:pt-24">
      ...
      <div className="flex flex-col gap-6">
        ...
        <p className="text-lg leading-relaxed text-muted-foreground w-full">
          Mama R's is a custom business tool built on the MERN stack (MongoDB, Express, React, Node.js). 
          It was a freelance project created to help a local business move away from paper logs. The system helps the owner 
          track inventory, record customer orders, and see daily sales totals in a secure digital environment.
        </p>
      ...
      <div className="rounded-xl border border-border/50 bg-card p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <Button disabled variant="secondary" className="flex-1 md:flex-none font-bold opacity-80 cursor-not-allowed">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-12">
        ...
        <div className="xl:col-span-2 space-y-12">
            ...
            <div className="grid gap-4">
              <div className="rounded-lg border border-border/50 bg-card/50 p-4">
                ...
                <p className="text-muted-foreground text-sm">
                  A clear view of daily performance. It shows total sales and revenue numbers instantly so the owner 
                  knows how the business is doing without calculating it manually.
                </p>
              </div>
              <div className="rounded-lg border border-border/50 bg-card/50 p-4">
                <h3 className="font-semibold text-foreground mb-1">
                ...
                <p className="text-muted-foreground text-sm">
                  Allows the user to add products and update stock levels. It keeps a history of changes to ensure 
                  items are not lost and stock counts remain accurate.
                </p>
              </div>
              <div className="rounded-lg border border-border/50 bg-card/50 p-4">
                <h3 className="font-semibold text-foreground mb-1">
                ...
                <p className="text-muted-foreground text-sm">
                  Generates simple reports focused strictly on income. It calculates total revenue from orders 
                  without complicating the view with expense tracking.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                The client needed to transition from manual pen-and-paper tracking to a digital system. 
                The main challenge was creating an interface that was powerful enough to handle sales data 
                but simple enough for non-technical staff to use easily.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-muted-foreground leading-relaxed list-disc pl-5 marker:text-primary">
                <li>
                  <strong>RESTful API Architecture:</strong> Designed a robust backend with Express.js to handle 
                  separate routes for products and orders. This keeps the data organized and secure.
                </li>
                <li>
                  <strong>Order Tracking:</strong> Built a system to record every customer order. This data is saved 
                  instantly to the database so revenue totals are always up to date.
                </li>
                <li>
                  <strong>Secure Authentication:</strong> Implemented JWT-based authentication. This protects 
                  sensitive business data and ensures only authorized staff can access the admin panel.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              This project honed my skills in translating specific business requirements into code. 
              It taught me how to build intuitive forms for non-technical users and the importance of 
              aggregating sales data on the backend to keep the frontend fast.
            </p>
          </section>
        </div>
